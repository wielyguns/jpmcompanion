...
import 'package:jpmcompanion/provider/listCourierViewModel.dart';
import 'package:jpmcompanion/widget/courierList.dart';
import 'package:jpmcompanion/widget/loadingScreen.dart';
import 'package:stacked/stacked.dart';

class ListCourierView extends StatefulWidget {
  @override
  _ListCourierViewState createState() => _ListCourierViewState();
}

class _ListCourierViewState extends State<ListCourierView> {
  @override
  Widget build(BuildContext context) {
    ScreenUtil.init(context);
    return ViewModelBuilder.reactive(
      viewModelBuilder: () => ListCourierViewModel(),
                      ...
                      body: Container(
                        child: SingleChildScrollView(
                          ...
                          child: (model.feedData.length != 0)
                              ? Column(
                                  children: model.feedData
                                      .map<Widget>((Courier item) {
                                    return Container(
