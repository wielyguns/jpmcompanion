...
import 'package:jpmcompanion/provider/listVendorViewModel.dart';
import 'package:stacked/stacked.dart';

class ListVendorView extends StatefulWidget {
  @override
  _ListVendorViewState createState() => _ListVendorViewState();
}

class _ListVendorViewState extends State<ListVendorView> {
  @override
  Widget build(BuildContext context) {
    ScreenUtil.init(context);
    return ViewModelBuilder.reactive(
      viewModelBuilder: () => ListVendorViewModel(),
                  ...
                  child: NestedScrollView(
                    ...
                    body: Container(
                      ...
                      child: (model.feedData.length != 0)
                          ? Column(
                              children:
                                  model.feedData.map<Widget>((Vendor item) {
                                return Container(
                                  alignment: Alignment.centerLeft,
