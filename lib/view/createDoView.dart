                        ...
                        children: [
                          GestureDetector(
                            ...
                            child: TimelineTile(
                              ...
                              beforeLineStyle: LineStyle(
                                color:
                                    (model.page >= 1) ? purpleTheme : borderBox,
                                thickness: 6,
                              ),
                          ...
                          GestureDetector(
                            ...
                            child: TimelineTile(
                              ...
                              afterLineStyle: LineStyle(
                                color:
                                    (model.page >= 2) ? purpleTheme : borderBox,
                                thickness: 6,
                              ),
                              startChild: Container(
                                alignment: Alignment.center,
                          ...
                          GestureDetector(
                            ...
                            child: TimelineTile(
                              ...
                              afterLineStyle: LineStyle(
                                color:
                                    (model.page >= 3) ? purpleTheme : borderBox,
                                thickness: 6,
                              ),
                              startChild: Container(
                                alignment: Alignment.center,
                          ...
                          GestureDetector(
                            ...
                            child: TimelineTile(
                              ...
                              afterLineStyle: LineStyle(
                                color:
                                    (model.page >= 4) ? purpleTheme : borderBox,
                                thickness: 6,
                              ),
                              startChild: Container(
                                alignment: Alignment.center,
                                  ...
                                  children: [
                                    ...
                                    if (model.tujuan.text != '')
                                      DeliveryOrderSelectField(
                                        ...
                                        trackingTypeValue: model.kecamatanValue,
                                        changeType: (value) {
                                        ...
                                        children: [
                                          ...
                                          Flexible(
                                            ...
                                            child: DeliveryOrderSelectField(
                                              ...
                                              changeType: (value) {
                                                model.changeJenisKiriman(value);
                                              },
                                            ),
                                          ),
                                        ],
