...
class DeliveryOrderInputMaskedField extends StatefulWidget {
  final hintText;
  final readOnly;
  ...
  const DeliveryOrderInputMaskedField({
    Key key,
    this.hintText,
    this.readOnly = false,
    this.onTap,
  ...
  DdeliveryOrderInputMaskedFieldState createState() =>
      DdeliveryOrderInputMaskedFieldState();
}

class DdeliveryOrderInputMaskedFieldState
    extends State<DeliveryOrderInputMaskedField> {
  String validation = '';
  @override
